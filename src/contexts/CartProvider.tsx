...
const localStorageKey = "@Syntax:cart";

export const CartPrvider = ({ children }: CartProviderProps) => {
    ...
    return <CartContext.Provider value={{ cart, add, remove, increment, decrement }}>
        {children}

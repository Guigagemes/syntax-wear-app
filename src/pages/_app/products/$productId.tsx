...
import { CEPForm } from '../../../componentes/CEPForm'
...
export const Route = createFileRoute('/_app/products/$productId')({
  ...
  head: ({ params }) => {
    ...
    const title = filteredProduct ? `${filteredProduct.name} - Produtos - SyntaxWear` : 'Produto não encontrado - SyntaxWear'
...
function RouteComponent() {
  ...
  if (!filteredProduct) return (
    <section className="container mb-10 pt-44 md:pt-53 pb-10 md:px-10 text-center text-black min-h-[70vh] flex flex-col items-center justify-center">
  ...
  return <section className="container mb-10 pt-44 md:pt-53 pb-10 md:px-10 ">
    ...
    <div className="flex justify-center gap-10">
      ...
      <div className="text-black">
        ...
        <p className='mb-2'>
          ...
          <span className='text-[#38373a] font-semibold'> {formatCurrency(inInstallmentsPrice)}
          </span>
        </p>
        ...
        <button className='bg-black text-white rounded-md p-5 w-full cursor-pointer hover:bg-gray-800' onClick={() => add(filteredProduct)}>

...
export const Categories = () => {
    return (
        <section className='container flex gap-2.5 lg:grid lg:grid-cols-4 lg:gap-4 md-10 overflow-x-auto scrollbar-hide snap-x snap-mandatory'>
            {categories.map((category, index) => (

                <div key={index} style={{backgroundImage:`url(${category.image})`}} className='h-125 bg-cover bg-center rounded-[20px] relative flex items-center justify-center text-white cursor-pointer shrink-0 w-[95%] md:w-1/2 lg:w-full'>
